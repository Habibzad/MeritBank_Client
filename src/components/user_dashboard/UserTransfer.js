...
function UserTransfer() {
  ...
  const submitTransfer = () => {
    ...
    fetch("https://merit-bank.herokuapp.com/api/transfer", requestOptions)
  ...
  return (
    <div>
      <h3 className="transfer-header">
        <i class="fas fa-chevron-circle-right"></i> Transfer
      </h3>
          ...
          >
            ...
            <option>
              {user.personalCheckingAccount != null
                ? user.personalCheckingAccount[0].accountNumber
                : null}
            </option>
            <option>
              {user.savingsAccounts != null
                ? user.savingsAccounts[0].accountNumber
                : null}
            </option>
            {user.cdAccounts != null
              ? user.cdAccounts.map((cd) => <option>{cd.accountNumber}</option>)
              : null}
          </select>
        </Form.Group>
        <Form.Group
